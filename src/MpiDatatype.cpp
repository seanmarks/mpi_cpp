...
MpiDatatype::MpiDatatype(const MpiDatatype& mpi_datatype)
{
	...
	if ( mpi_datatype.is_committed_ ) {
		...
		this->is_committed_ = true;
	}
	else {
		this->is_committed_ = false;
	}
#else
	this->mpi_datatype_ = mpi_datatype.mpi_datatype_;
	this->is_committed_ = mpi_datatype.is_committed_;
#endif // MPI_ENABLED
}
...
// TODO add remaining primitives, incl. COMPLEX
